  ...
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        Track meals, workouts, and finances in one intelligent platform. 
        AI-powered insights help you build better habits and achieve your goals.
      </p>
      ...
      <div className="mt-36 lg:mt-44">
        ...
        <div className="mt-8 flex items-center justify-center gap-x-8 sm:flex-col sm:gap-x-0 sm:gap-y-10 xl:flex-row xl:gap-x-12 xl:gap-y-0">
          ...
          <div className="flex items-center gap-x-8">
            <div className="text-2xl font-bold text-slate-600">1M+</div>
            <div className="text-slate-500">Meals Analyzed</div>
          </div>
          <div className="flex items-center gap-x-8">
            <div className="text-2xl font-bold text-slate-600">4.9★</div>
            <div className="text-slate-500">App Rating</div>
          </div>
        </div>
      </div>
    </Container>
